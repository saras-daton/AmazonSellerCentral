{% if var('FBAManageInventoryHealthReport') %}
    {{ config( enabled = True,
    post_hook = "drop table {{this|replace('FBAManageInventoryHealthReport', 'FBAManageInventoryHealthReport_temp')}}"
    ) }}
{% else %}
...
{% endif %}
    ...
    {% for i in results_list %}
        ...
        {%- set query -%}
        {{action1}}
        {{tbl|replace('FBAManageInventoryHealthReport', 'FBAManageInventoryHealthReport_temp')}}
    ...
    {% endfor %}
    select * from {{this|replace('FBAManageInventoryHealthReport', 'FBAManageInventoryHealthReport_temp')}}    
