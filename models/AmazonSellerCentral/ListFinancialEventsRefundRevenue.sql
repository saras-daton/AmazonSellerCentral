...
{% endif %}
    ...
    {% for i in results_list %}
        ...
        {% if target.type=='snowflake' %} 
            ...
            ItemChargeAdjustmentList.value:ChargeType :: varchar as ItemChargeAdjustmentList_ChargeType,
        ...
        {% else %}
            ...
            coalesce(ItemChargeAdjustmentList.ChargeType,'N/A') as ItemChargeAdjustmentList_ChargeType,
