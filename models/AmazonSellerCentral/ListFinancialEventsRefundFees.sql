{% if var('ListFinancialEventsRefundFees') %}
    {{ config( enabled = True,
    post_hook = "drop table {{this|replace('ListFinancialEventsRefundFees', 'ListFinancialEventsRefundFees_temp')}}"
    ) }}
{% else %}
...
{% endif %}
    ...
    {% for i in results_list %}
        ...
        {%- set query -%}
        {{action1}}
        {{tbl|replace('ListFinancialEventsRefundFees', 'ListFinancialEventsRefundFees_temp')}}
    ...
    {% endfor %}
    select * from {{this|replace('ListFinancialEventsRefundFees', 'ListFinancialEventsRefundFees_temp')}}    
    )
