{% if var('ListFinancialEventsRefundPromotions') %}
    {{ config( enabled = True,
    post_hook = "drop table {{this|replace('ListFinancialEventsRefundPromotions', 'ListFinancialEventsRefundPromotions_temp')}}"
    ) }}
{% else %}
...
{% endif %}
    ...
    {% for i in results_list %}
        ...
        {%- set query -%}
        {{action1}}
        {{tbl|replace('ListFinancialEventsRefundPromotions', 'ListFinancialEventsRefundPromotions_temp')}}
    ...
    {% endfor %}
    select * from {{this|replace('ListFinancialEventsRefundPromotions', 'ListFinancialEventsRefundPromotions_temp')}}    
    )
